...
Use the `column_to_rowname()` function
...
There is a significant association (i.e. non-independence between site and lizard tail breakage) ($\chi$^2^(`r lizard_tidy$parameter`) = `r round(lizard_tidy$statistic,3)`, *p* = `r round(lizard_tidy$p.value,3)`)
